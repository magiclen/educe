...
fn basic_1() {
    ...
    assert_eq!(
        Ordering::Greater,
        Enum::Struct { f1: 2 }.cmp(&Enum::Struct { f1: 1 })
    );

    assert_eq!(
        Ordering::Less,
        Enum::Struct { f1: 1 }.cmp(&Enum::Struct { f1: 2 })
    );
...
fn basic_2() {
    ...
    assert_eq!(
        Ordering::Greater,
        Enum::Struct { f1: 2, f2: 1 }.cmp(&Enum::Struct { f1: 1, f2: 2 })
    );

    assert_eq!(
        Ordering::Less,
        Enum::Struct { f1: 1, f2: 2 }.cmp(&Enum::Struct { f1: 2, f2: 1 })
    );
...
fn ignore() {
    ...
    assert_eq!(
        Ordering::Less,
        Enum::Struct { f1: 1, f2: 2 }.cmp(&Enum::Struct { f1: 1, f2: 3 })
    );

    assert_eq!(
        Ordering::Equal,
        Enum::Struct { f1: 2, f2: 2 }.cmp(&Enum::Struct { f1: 1, f2: 2 })
    );
...
fn compare_without_trait_1() {
    ...
    enum Enum {
        ...
        Tuple(u8, #[educe(Ord(method = "cmp"))] u8),
    }
    ...
    assert_eq!(
        Ordering::Equal,
        Enum::Struct { f1: 1, f2: 2 }.cmp(&Enum::Struct { f1: 1, f2: 2 })
    );
...
fn compare_with_trait_3() {
    ...
    enum Enum {
        ...
        Tuple(u8, #[educe(Ord(trait = "A", method = "compare"))] u8),
    }
