...
/// The parsed settings of a field-level `PartialEq` attribute.
pub(crate) struct FieldAttribute {
    pub(crate) ignore: bool,
    pub(crate) method: Option<Path>,
}

/// Parses field-level `PartialEq` metas; the `enable_*` switches describe which parameters are allowed for the current shape of data.
...
impl FieldAttributeBuilder {
    ...
    /// Scans the `#[educe(...)]` attributes of a field and parses its `PartialEq` meta if present.
