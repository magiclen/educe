...
#[inline]
pub(crate) fn no_deref_mut_field(meta: &Meta) -> syn::Error {
    syn::Error::new_spanned(meta, "there is no field which is assigned for `DerefMut`")
}

#[inline]
pub(crate) fn no_deref_mut_field_of_variant(variant: &Variant) -> syn::Error {
