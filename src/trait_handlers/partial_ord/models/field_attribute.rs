...
impl FieldAttributeBuilder {
    pub fn from_partial_ord_meta(&self, meta: &Meta) -> FieldAttribute {
        ...
        let correct_usage_for_compare = {
            let usage = vec![stringify!(#[educe(PartialOrd(compare(method = "path_to_method")))]), stringify!(#[educe(PartialOrd(compare(trait = "path_to_trait")))]), stringify!(#[educe(PartialOrd(compare(trait = "path_to_trait", method = "path_to_method_in_trait")))]), stringify!(#[educe(PartialOrd(compare(method("path_to_method"))))]), stringify!(#[educe(PartialOrd(compare(trait("path_to_trait"))))]), stringify!(#[educe(PartialOrd(compare(trait("path_to_trait"), method("path_to_method_in_trait"))))]), stringify!(#[educe(PartialOrd(compare = "path_to_method"))]), stringify!(#[educe(PartialOrd(compare("path_to_method")))])];

            usage
        };

        let correct_usage_for_rank = {
            let usage = vec![stringify!(#[educe(PartialOrd(rank = rank_value))]), stringify!(#[educe(PartialOrd(rank(rank_value)))])];
